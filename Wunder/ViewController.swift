...
extension ViewController: UITableViewDataSource, UITableViewDelegate{
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        {
            cell.nameLabel.text = carViewModel.carName(atIndex: indexPath.row)
            cell.addressLabel.text = carViewModel.carAddress(atIndex: indexPath.row)
            cell.vinLabel.text = carViewModel.carVin(atIndex: indexPath.row)
